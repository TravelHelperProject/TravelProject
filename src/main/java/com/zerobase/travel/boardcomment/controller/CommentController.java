...
public class CommentController {
    ...
    public ResponseEntity<String> commentInsert(@PathVariable long boardId,
    ...
    public ResponseEntity<String> commentModify(@PathVariable long boardId,
                                                @PathVariable long replyId,
                                                @RequestBody ModifyBoardDTO modifyBoardDTO,
                                                @AuthenticationPrincipal UserDTO user) {
        if(service.get(replyId).getUserId() == user.getUserId()) {

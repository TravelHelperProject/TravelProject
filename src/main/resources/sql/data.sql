...
INSERT INTO `accommodation` (`room_id`, `room_name`, `price`, `number_rooms`, `number_people`, `checkin`, `checkout`, `information`, `created_at`, `updated_at`, `latitude`, `longitude`)
VALUES
    (1, '아늑한 산장', 150, 2, 4, '2023-08-01', '2023-08-05', '자연 속 아름다운 산장', '2023-07-30 12:00:00', '2023-07-30 12:00:00', 40.7128, -74.0060),
    (2, '럭셔리 리조트', 500, 3, 6, '2023-09-10', '2023-09-15', '편안한 리조트와 스파', '2023-07-30 13:00:00', '2023-07-30 13:00:00', 34.0522, -118.2437),
    (3, '해변별장', 300, 2, 4, '2023-08-20', '2023-08-25', '아름다운 해변가의 별장', '2023-07-30 14:00:00', '2023-07-30 14:00:00', 25.7617, -80.1918);
...
INSERT INTO `accommodation_review` (`review_id`, `room_id`, `user_id`, `content`, `writer`, `cretaed_at`, `updated_at`, `grade`)
VALUES
